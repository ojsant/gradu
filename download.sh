...
then
    ...
    wget -r -nv --show-progress --tries=10 -nc -nH -np -nd -P "data" -A "*.cdf" "https://cdaweb.gsfc.nasa.gov/pub/data/wind/3dp/3dp_sfpd/$2/"
    wget -r -nv --show-progress --tries=10 -nc -nH -np -nd -P "data" -A "*.cdf" "https://cdaweb.gsfc.nasa.gov/pub/data/wind/3dp/3dp_sopd/$2/"
